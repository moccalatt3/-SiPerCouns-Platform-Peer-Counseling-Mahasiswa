            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="nav-link nav-icon" href="#" data-bs-toggle ="dropdown">
                        ...
                        <span class="custom-badge custom-bg-primary custom-badge-number">0</span>
                    ...
                    <div class="row">
                            ...
                            <div class="card info-card sales-card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div
                                            class="card-icon rounded-circle d-flex align-items-center justify-content-center user-icon">
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <div class="card info-card revenue-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Konsultasi <span class="small-text">| Today</span></h5>

                                    <div class="d-flex align-items-center">
                                        <div
                                            class="card-icon rounded-circle d-flex align-items-center justify-content-center team-icon">
                                            <i class="bi bi-chat-square-dots"></i>
                                        </div>
                                        <div class="ps-3">
                                            <h6>{{ $jumlahKonsultasi }}</h6>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xxl-4 col-xl-12">
                            ...
                            <div class="card info-card customers-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Clear <span class="small-text">| Today</span></h5>

                                    <div class="d-flex align-items-center">
                                        <div
                                            class="card-icon rounded-circle d-flex align-items-center justify-content-center clipboard-icon">
                            ...
                            <div class="news">
                                @foreach ($artikels as $artikel)
                                    <div class="post-item clearfix">
                                        <img src="{{ asset('storage/' . $artikel->img_artikel) }}"
                                            alt="{{ $artikel->judul }}">
